...
class User(AbstractUser):
    ...
    address = models.CharField(max_length=60, verbose_name=_('Адрес'))
    apartment = models.CharField(max_length=60, verbose_name=_('Дом'))
    ...
    scan_out = models.ImageField(upload_to='scan_out',
                                 verbose_name=_('Паспорт внешняя часть'))
    scan_in = models.ImageField(upload_to='scan_in',
                                verbose_name=_('Паспорт внутреняя часть'))
